...
export const Header: React.FC<HeaderProps> = ({ deployedNodeCount, notificationData }) => {
  const { notifications, isNotificationOpen, setIsNotificationOpen, notificationRef, clearNotifications } = notificationData;
