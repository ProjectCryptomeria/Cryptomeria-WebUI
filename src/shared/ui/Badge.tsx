...
export const Badge: React.FC<{
  ...
  color?: 'slate' | 'blue' | 'green' | 'red' | 'yellow' | 'indigo' | 'purple';
  className?: string;
  ...
  return (
    <span
      className={`px-2.5 py-1 rounded-lg text-[10px] font-bold border uppercase tracking-wide ${colors[color]} ${className}`}
    >
      {children}
    </span>
  );
