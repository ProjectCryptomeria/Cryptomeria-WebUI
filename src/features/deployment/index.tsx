    ...
    <div className="h-full flex flex-col pb-10">
      ...
      >
        ...
        <div className="flex gap-4 justify-center">
          ...
          <Button variant="danger" onClick={confirmReset} icon={Trash2}>
            リセット実行
          </Button>
        </div>
      </Modal>
            ...
            <div className="relative z-10">
              ...
              <div className="text-[10px] font-mono text-slate-400 bg-slate-900/50 p-3 rounded-xl border border-slate-700/50 mt-2">
                <div className="flex justify-between">
                  <span>Context:</span> <span className="text-slate-200">minikube</span>
                </div>
                <div className="flex justify-between">
                  <span>Namespace:</span> <span className="text-slate-200">default</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex gap-3 flex-wrap">
                  {['DataChain', 'MetaChain', 'Relayer'].map(t => (
                    <label
                      key={t}
                      className="flex items-center gap-2 px-4 py-2.5 border border-slate-200 rounded-xl cursor-pointer hover:bg-slate-50 hover:border-indigo-200 transition-all"
                    >
                      <input
                        type="checkbox"
                        defaultChecked
              ...
              {isDockerBuilt && (
                <div className="animate-in fade-in slide-in-from-top-2">
                  <Badge
                    color="green"
                    className="w-full flex items-center justify-center py-2 text-xs"
                  >
            ...
            <div className="space-y-8">
              <div>
                <div className="flex justify-between mb-4">
                  ...
                  <span className="text-base font-mono font-bold text-emerald-600 bg-emerald-50 px-3 py-1 rounded-lg border border-emerald-100">
                    {scaleCount} Nodes
                  </span>
                </div>
                <input
              ...
              {!isDockerBuilt && (
                <div className="text-xs bg-orange-50 text-orange-600 p-4 rounded-2xl border border-orange-100 flex items-start gap-3">
                  ...
                  <span className="font-medium">
                    デプロイする前にDockerイメージをビルドする必要があります。
                  </span>
                </div>
              )}
