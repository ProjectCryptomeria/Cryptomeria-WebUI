...
import { createExecutionSlice, ExecutionSlice } from '@/features/experiment/model/store';
import { GlobalState } from '@/shared/store/types';
import { act } from '@testing-library/react';
import { vi } from 'vitest';

// createExecutionSliceが依存するメソッドを含むGlobalStateの最小モック
type TestStore = ExecutionSlice & Pick<GlobalState, 'addToast' | 'registerResult' | 'updateUserBalance'>;
