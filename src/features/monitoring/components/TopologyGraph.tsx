...
import { NodeStatus, PacketEvent } from '@/entities/node';
...
const TopologyGraph: React.FC<TopologyGraphProps> = ({ nodes }) => {
  ...
  const dataNodeLayout = useMemo(() => {
    ...
    const startOffset =
      dataArea.xStart + (availableWidth - totalUsedWidth) / 2 + effectiveNodeWidth / 2;
        ...
        <g transform={`translate(${controlPos.x}, ${controlPos.y})`}>
          ...
          <g transform="translate(0, 50)">
            ...
            <text
              y="12"
              textAnchor="middle"
              className="fill-blue-100 text-[10px] font-bold font-mono tracking-wider uppercase"
            >
              Orchestrator
            </text>
          </g>
          <text y="80" textAnchor="middle" className="fill-blue-400 text-[9px] font-mono">
            ControlChain
          </text>
        </g>
        ...
        <g transform={`translate(${metaPos.x}, ${metaPos.y})`}>
          ...
          <g transform="translate(0, 50)">
            ...
            <text
              y="12"
              textAnchor="middle"
              className="fill-indigo-100 text-[10px] font-bold font-mono tracking-wider uppercase"
            >
              Registry
            </text>
          </g>
          <text y="80" textAnchor="middle" className="fill-indigo-400 text-[9px] font-mono">
            MetaChain
          </text>
        </g>
        ...
        {dataNodeLayout.positions.map(node => (
          ...
          >
            ...
            <rect
              ...
              stroke={
                nodeFlash[node.id] ? '#ffffff' : node.status === 'active' ? '#10b981' : '#ef4444'
              }
            ...
            <g transform="translate(0, 50)">
              ...
              <text
                y="12"
                textAnchor="middle"
                className="fill-slate-300 text-[11px] font-mono font-bold"
              >
                {node.id}
              </text>
            </g>
            ...
            <g transform="translate(0, 74)">
              ...
              />
              <text x="-10" y="3" className="fill-slate-500 text-[10px] font-mono">
                Height: {node.height}
              </text>
            </g>
          </g>
