...
export const SlideOver: React.FC<{
  ...
  <>
    ...
    <div
      className={`fixed right-0 top-0 bottom-0 ${width} bg-white shadow-2xl transition-transform duration-300 ease-in-out z-50 flex flex-col border-l border-slate-100 ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}
    >
